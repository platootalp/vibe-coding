...
import { applyTaskUpdates, deriveTaskPlan, summarizeProgress } from "./services/taskService.js";
...
export class SddEngine {
    ...
    async updateConstitution(options) {
    ...
    async updateTemplates(partial) {
        this.customTemplateOverrides = {
            ...this.customTemplateOverrides,
            ...partial
        };
        this.templates = resolveTemplates(this.customTemplateOverrides);
        await writeFileSafe(this.templateStorePath, JSON.stringify(this.customTemplateOverrides, null, 2));
    ...
    configureProjectRoot(root, overrides) {
