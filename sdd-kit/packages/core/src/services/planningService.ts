...
export function buildTechnicalPlan(specification: SddSpecification): SddTechnicalPlan {
...
function derivePrinciples(spec: SddSpecification): SddArchitecturePrinciple[] {
...
function suggestTechnologyStack(spec: SddSpecification): SddTechnologyChoice[] {
  return [
    {
      layer: "接口层",
...
function buildDeliveryPhases(spec: SddSpecification): SddDeliveryPhase[] {
